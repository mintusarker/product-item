        ...
        <div className="h-[600px] flex flex-col justify-center items-center">
            <div className='w-96 shadow-lg shadow-slate-600 rounded-md p-7'>
                ...
                <form onSubmit={handleSubmit(handleLogin)}>
                    ...
                    <input className='btn btn-success my-3 w-full' value='Login' type="submit" />
                </form>

                <p className='font-semibold text-center'>New to here ?<Link to='/sign_up' className='text-secondary border-b-2 ml-6 border-green-500'>Create new account</Link> </p>
